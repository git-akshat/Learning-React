export const resData = [
  {
    ...
    analytics: {
      context: "seo-data-543c501d-8473-4b2e-b13d-e5abe3c08e9f",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      name: "Food Club",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/11/14/53f106f4-d8ab-4412-a382-827c390f3f8b_990661.jpg",
      locality: "Chhindwara City",
      areaName: "Chhindwara City",
      costForTwo: "₹300 for two",
      cuisines: ["Thalis", "Fast Food"],
      veg: true,
      parentId: "81109",
      avgRatingString: "NEW",
      sla: {
    ...
    cta: {
      link: "https://www.swiggy.com/city/chhindwara/food-club-chhindwara-city-rest990661",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
